...
export const validateLoginForm = (
  ...
  if (!loginId.trim()) {
    ...
    errors.push({
      field: "loginId",
      message: "Login ID must be between 3 and 50 characters",
    });
  }
...
export const validateCreateRoleForm = (
  ...
  if (!nameEnglish.trim()) {
    errors.push({
      field: "nameEnglish",
      message: "English role name is required",
    });
  } else if (!validateRoleName(nameEnglish)) {
    errors.push({
      field: "nameEnglish",
      message: "English role name must be between 3 and 100 characters",
    });
  }
  ...
  if (!nameMarathi.trim()) {
    errors.push({
      field: "nameMarathi",
      message: "Marathi role name is required",
    });
  } else if (!validateRoleName(nameMarathi)) {
    errors.push({
      field: "nameMarathi",
      message: "Marathi role name must be between 3 and 100 characters",
    });
  }
